<?php
$title = "Exemple de Carnet de Tir Numérique — Tireur.org";
$meta_description = "Exemple complet et pré-rempli du carnet de tir numérique local de Tireur.org. Découvrez le suivi d'armes, de tirs (round count), de dispersion d'impacts et d'entretien.";
include 'header.php';
?>
...
<div id="cadre">
    ...
    $breadcrumb_links = [
        ...
        ['url' => '/carnet-de-tir.php', 'label' => 'Carnet de tir'],
        ['label' => 'Démonstration'],
    ];
    include $_SERVER['DOCUMENT_ROOT'] . '/includes/breadcrumb.php';
    ?>

    <!-- Bandeau informatif de démonstration -->
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:1rem; margin-bottom:1rem;">
        <div>
            <h1 style="margin-bottom:0.25rem;"><span id="logbook-main-title">Carnet de Tir Numérique</span> <span id="logbook-demo-badge" style="font-size: 0.5em; font-weight: normal; vertical-align: middle; background: var(--color-border); color: var(--color-text-light); padding: 0.2rem 0.5rem; border-radius: 12px; margin-left: 0.5rem; border: 1px solid var(--color-border);">EXEMPLE</span> <span style="font-size: 0.5em; font-weight: normal; vertical-align: middle; background: rgba(9, 132, 227, 0.1); color: var(--color-primary); padding: 0.2rem 0.5rem; border-radius: 12px; margin-left: 0.5rem; border: 1px solid rgba(9, 132, 227, 0.2);">beta</span></h1>
...
<script>
    // Activation du mode démonstration pour pré-remplir les données fictives
    const IS_DEMO = true;
